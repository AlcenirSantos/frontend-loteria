...
import { lotofacils } from '@/services/lotofacil';
...
const User: React.FC = () => {
  ...
  const columns: ProColumns<API.User>[] = [
    ...
    {
      title: <FormattedMessage id="pages.user.dezesseis" defaultMessage='Onze' />,
      dataIndex: 'onze',
      sorter: true,
    },
    {
      title: <FormattedMessage id="pages.user.dezessete" defaultMessage='Doze' />,
      dataIndex: 'doze',
      sorter: true,
    },
    {
      title: <FormattedMessage id="pages.user.dezoito" defaultMessage='Treze' />,
      dataIndex: 'treze',
      sorter: true,
    },
    {
      title: <FormattedMessage id="pages.user.dezenove" defaultMessage='Quatorze' />,
      dataIndex: 'quatorze',
      sorter: true,
    },
    {
